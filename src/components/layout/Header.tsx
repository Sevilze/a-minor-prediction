    ...
    <header className="flex flex-shrink-0 w-full items-center justify-between border-b border-white/10 px-4 md:px-6 py-3 bg-background-dark z-20 relative">
      ...
      <div className="flex items-center gap-4 md:gap-8">
        ...
        <nav className="flex items-center gap-4 md:gap-6">
          <a
            href="#"
            className="hidden sm:block text-white/60 hover:text-white text-sm font-medium transition-colors font-sans"
          >
            About
          </a>
          <a
            href="#"
            className="text-white/60 hover:text-white text-sm font-medium transition-colors font-sans"
          >
            Help
          </a>
          {user ? (
